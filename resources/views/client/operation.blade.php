        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                        <form action="{{ route('client.physique.operation.store') }}" method="POST" class="p-4 md:p-5" id="formulaire">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="client" id="client" class="w-full px-3 py-2 border rounded-lg" required>
                                    ...
                                    @foreach ($personnesPhysiques as $personnePhysique)
                                        <option value="{{ $personnePhysique->id }}">{{ $personnePhysique->prenom }} {{ $personnePhysique->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <tr class="space-y-4 border-b border-[#7D7272] border-opacity-40">
                        ...
                        <td>
                            @foreach ($personnesPhysiques as $personne)
                                @if ($personne->id === $operation->personne_physique_id)
                                    ...
                                    <div onclick="event.stopPropagation();" id="crud-modale-{{ $operation->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" onclick="event.stopPropagation();">
                                                ...
                                                <form action="{{ route('client.physique.operation.update', ['operation' => $operation->id])  }}" method="POST" class="p-4 md:p-5" id="formulaire">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-4">
                                                        <label class="block text-sm text-gray-600 mt-2" for="Nature">Nature</label>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <form action="{{ route('client.physique.operation.destroy', ['operation' => $operation->id]) }}" method="POST" onclick="event.stopPropagation();">
                                                        @csrf
                                                        @method('DELETE')
